...
% Basis-family indexing table used by the higher-order integrals:
%   edge1..edge4 : edge-based hierarchical functions from lowest to highest
%                  polynomial order
%   face1..face4 : face-based hierarchical functions from lowest to highest
%                  polynomial order
% Each row stores local node connectivity + order tags for one basis term.
