...
% [kappa_est, invA1_est, it] = condest_hager_core(Amatris, 18);
...
% save('Z:\kod\3DMTINVUns\makale5kod\data\lineersonuc.mat','roa','faza','flist','Zler','Tler');




% B=load('makaleveri.mat');
